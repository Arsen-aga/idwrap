...
<main class="main" id="okleyka-page">
      ...
      <div class="front-block__inner relative">
        <div class="breadcrumbs">
          <ul class="breadcrumbs__list">
            ...
            <li class="breadcrumbs__point">
              <a class="breadcrumbs__link active" href="#">Оклейка автомобилей</a>
            </li>
          </ul>
        </div>
        <div class="front-block__top">
          <div class="front-block__top-logo">
  ...
  <section class="sec-4 space-negative-sec">
      ...
      <div class="sec-map__container container">
        <div class="sec-map__contacts">
          <div class="sec-map__contacts-inner">
            ...
            <form action="#" class="form sec-map__form form form-submit">
              <input type="hidden" name="newToken" value="<?php echo (rand(10000, 99999)) ?>">
