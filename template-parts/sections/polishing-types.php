      ...
      <div class="container">
        ...
        <div class="polishing-types__items">
          <?php while (have_rows('polishing-types_cards')) : the_row();
            ...
            <div class="polishing-types__item default-elem change-popup-item">
              ...
              <div class="default-elem__inner polishing-types__item-inner">
                <?php if (get_sub_field('card_title')): ?>
                  <h4 class="default-elem__title polishing-types__item-title change-popup-title">
                ...
                <?php endif; ?>
                <a class="polishing-types__item-btn default-elem__btn change-popup _main-btn" href="#modal-main" data-fancybox>
    ...
    <section class="polishing-types">
      <div class="container">
        ...
        <div class="polishing-types__cards">
          <?php while (have_rows('polishing-types_cards')) : the_row();
            $img = get_sub_field('card_img');  ?>
            <div class="polishing-types__card default-item change-popup-item">
      ...
      <div class="container">
        ...
        <div class="polishing-types__cards grid-6">
          <?php while (have_rows('polishing-types_cards')) : the_row();
            ...
            <?php } else { ?>
              <div class="polishing-types__card default-item change-popup-item default-item__horizontal">
                <div class="default-item__wrapper">
                  <img class="default-item__img _img" src="<?php echo $img['url']; ?>" alt="<?php echo $img['alt']; ?>">
                </div>
                <div class="default-item__info">
