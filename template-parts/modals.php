...
<div id="callback-modal" style="display: none;" class="modal modal__callback">
  <div class="modal__callback-layout">
    ...
    <form id="modal__form" class="sec-form12__form modal__form form time-check form-submit" action="#" method="POST"
      ...
      <div class="sec-6__form-methodbox sec-12__form-methodbox">
        <label class="label-check">
          <input type="radio" name="method" value="Звонок" required checked>
          <span class="label-check__inner callbtn">
            ...
            <span class="label-check__text">
              Звонок
            </span>
          </span>
        </label>
        <label class="label-check">
          <input type="radio" name="method" value="WhatsApp" required checked>
          <span class="label-check__inner whatsapp">
      ...
      <div class="modal__form-inner">
        <label class="label-check">
          <input class="time-toggle" type="radio" name="call_time" value="Сейчас" required checked>
          <span class="label-check__inner">
            <span class="label-check__text">
              Сейчас
            </span>
          </span>
        ...
        <label class="label-check">
          <input class="time-toggle" type="radio" name="call_time" value="По времени" required>
          <span class="label-check__inner">
            <span class="label-check__text">
              По времени
            </span>
      ...
      <input class="modal__form-calltime sec-12__form-number time-input" disabled id="call_time_input" name="call_time_input"
...
<div class="_modal modal__quiz" style="display: none" id="quiz">
  <form class="form sec-4__form form form-submit" action="#" method="POST" enctype="multipart/form-data">
    ...
    <div class="quiz-step quiz-step2 step-5 steps-5">
      ...
      <div class="sec-6__form-methodbox sec-12__form-methodbox">
        <label class="label-check">
          <input type="radio" name="method" value="Телефон" required checked>
          <span class="label-check__inner callbtn">
            <svg width="14" height="22" viewBox="0 0 14 22" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_130_1508)">
    ...
    <div class="sec-12__content">
      <form action="#" method="POST" enctype="multipart/form-data" class="form sec-12__form form form-submit">
        ...
        <div class="sec-12__form-methodbox">
          ...
          <label class="label-check">
            <input type="radio" name="method" value="WhatsApp" required>
            <span class="label-check__inner whatsapp">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_130_1005)">
          ...
          <label class="label-check">
            <input type="radio" name="method" value="Telegram" required>
            <span class="label-check__inner telegram">
