        ...
        <div class="services-price__left">
          ...
          <div class="services-price__items">
            <div class="services-price__item">
              <h4 class="services-price__item-title">
                Антигравийная оклейка
              </h4>
              <div class="services-price__item-price">
                <p class="services-price__item-num">
                  1000 ₽
                </p>
                <a class="services-price__item-link" href="#" data-fancybox="">
                  Или напишите свою цену
                </a>
              </div>
              <a class="services-price__item-btn _main-btn" href="#" data-fancybox="">
                Записаться
              </a>
            </div>
            <div class="services-price__item">
